...
use App\Models\Zone;
use App\Repositories\Admin\SingleRebo\CouponRepository;
...
class CouponController extends BaseController
{
    ...
    public function index(Request $request, $with = [], $withCount = [], $filter = '', $paginate = 10, $whereHas = [])
    {
        ...
        */
        return view($this->view . '.index', compact('coupons'));
    }
    ...
    public function create()
    {
        ...
        return view($this->view . '.create', compact('compilations','places'));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->view . '.edit', compact('record','compilations','places'));
    }
