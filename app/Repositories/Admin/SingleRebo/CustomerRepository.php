...
*/
    ...
    public function details($id){
         $data['order_amounts']=Order::where(['restaurant_id'=>$id,'order_status'=>'delivered'])->sum('order_amount');
          ...
          $data['orders']= Order::where('restaurant_id',$id)->with('customer')->get();
          $data['withdraw']= WithdrawRequest::where('vendor_id',$data['place']['vendor_id'])->addSelect( DB::raw('SUM(amount) AS withdraw_amount'))->get();
